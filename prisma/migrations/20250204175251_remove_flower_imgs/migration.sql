/*
  ...
  - You are about to drop the column `bloomImg` on the `Flower` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "Flower" DROP COLUMN "bloomImg",
DROP COLUMN "growthImg1",
DROP COLUMN "growthImg2",
DROP COLUMN "growthImg3",
DROP COLUMN "witherImg",
ADD COLUMN     "FlowerImg" TEXT;
